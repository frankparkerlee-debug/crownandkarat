...
export default function StepPhotos({ data, updateData, onNext, onBack }) {
  ...
  return (
    <div>
      <h3 className="text-lg font-medium text-warm-100 mb-2">Add photos</h3>
      ...
      <div
        ...
        className="border-2 border-dashed border-warm-600 rounded-lg p-8 text-center hover:border-accent/50 transition-colors cursor-pointer"
        onClick={() => document.getElementById('photo-input')?.click()}
      >
        <svg className="w-12 h-12 mx-auto text-warm-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
        </svg>
        <p className="mt-4 text-warm-400">
          Drag and drop photos here, or <span className="text-accent">browse</span>
        </p>
        <p className="mt-1 text-xs text-warm-500">Up to 5 photos, max 5MB each</p>
        <input
          id="photo-input"
          type="file"
          accept="image/*"
